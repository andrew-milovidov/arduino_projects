...
void loop() {
    ...
    if(Serial.available()){                          //Send commands over serial to play
      switch(Serial.read()){
        case 'r': audio.startRecording("test.wav",22000,A0); break;    //Record at 16khz sample rate on pin A0
        ...
        case 'p': audio.play("test.wav", (byte)0, false); break;                       //Play the recording 
        //case 'p': audio.play("test.wav"); break;                       //Play the recording 
        case 'P': audio.play("test.wav", (byte)1, false); break;                       //Play the recording 
